...
class MainApp():
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.wm_title("Servidor")
        self.iconbitmap("unoserver.png")
...
class ServerWindow(tk.Frame):
    def __init__(self, parent, controller):
        ...
        tk.Frame.iconbitmap("unoserver.png")
        ...
        port_label = ttk.Label(self, text="Puerto: ")
        ...
        playerno_label = ttk.Label(self, text="Número de jugadores: ")
